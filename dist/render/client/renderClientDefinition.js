...
exports.renderClientDefinition = function(schema, ctx) {
  ...
  if (queryType) {
    types.push(
      requestTypeName_1.requestTypeName(queryType),
      objectType_1.chainTypeName(queryType, 'Promise'),
      queryType.name,
    )
    imports.push(
      requestTypeName_1.requestTypeName(queryType),
  ...
  if (mutationType) {
    types.push(
      requestTypeName_1.requestTypeName(mutationType),
      objectType_1.chainTypeName(mutationType, 'Promise'),
      mutationType.name,
    )
    imports.push(
      requestTypeName_1.requestTypeName(mutationType),
  ...
  if (subscriptionType) {
    types.push(
      requestTypeName_1.requestTypeName(subscriptionType),
      objectType_1.chainTypeName(subscriptionType, 'Observable'),
