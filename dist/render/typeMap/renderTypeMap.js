...
exports.renderTypeMap = function(schema, ctx) {
  ...
  Object.keys(schema.getTypeMap())
    .filter(function(t) {
      return !excludedTypes_1.excludedTypes.includes(t)
    })
    .map(function(t) {
      return schema.getTypeMap()[t]
    })
    .map(function(t) {
      ...
      else if (graphql_1.isUnionType(t)) result[t.name] = unionType_1.unionType(t, ctx)
      else if (graphql_1.isScalarType(t) || graphql_1.isEnumType(t)) result[t.name] = scalarType_1.scalarType(t, ctx)
    })
