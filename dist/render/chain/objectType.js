...
exports.chainTypeName = function(type, wrapper) {
...
exports.objectType = function(type, ctx, wrapper) {
  var fieldStrings = Object.keys(type.getFields()).map(function(fieldName) {
    ...
    var stopChain =
      graphql_1.isListType(field.type) ||
    ...
    var argsOptional = !field.args.find(function(a) {
      return graphql_1.isNonNullType(a.type)
    })
    ...
    var fieldType = resolvable
      ? stopChain
        ? '{execute:(request:' +
          requestTypeName_1.requestTypeName(resolvedType) +
          ',defaultValue?:' +
          executeReturnType +
          ')=>' +
          executeReturnTypeWrapped +
          '}'
        : exports.chainTypeName(resolvedType, wrapper) +
          '&{execute:(request:' +
          requestTypeName_1.requestTypeName(resolvedType) +
          ',defaultValue?:' +
          executeReturnType +
