...
exports.stripAndWrap = void 0
var common_tags_1 = require('common-tags')
var comment_1 = require('./comment')
exports.stripAndWrap = function(tsa) {
  return '\n' + common_tags_1.stripIndent(tsa) + '\n'
}
test('deprecated', function() {
  expect(comment_1.comment({ deprecated: 'deprecation reason' })).toBe(
    exports.stripAndWrap(
      templateObject_1 ||
...
test('single line', function() {
  expect(comment_1.comment({ text: 'single line' })).toBe(
    exports.stripAndWrap(
      templateObject_3 ||
...
test('single line deprecated', function() {
  expect(comment_1.comment({ text: 'single line', deprecated: 'deprecation reason' })).toBe(
    exports.stripAndWrap(
      templateObject_4 ||
...
test('multiline deprecated', function() {
  expect(comment_1.comment({ text: 'multiline\ntext', deprecated: 'deprecation reason' })).toBe(
    exports.stripAndWrap(
      templateObject_6 ||
