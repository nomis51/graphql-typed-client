...
test('unionType', function() {
  return render_1.typeRenderTestCase(__dirname, 'unionType', unionType_1.unionType, ['Union', 'UnionD', 'UnionMD'])
})
test('inputObjectType', function() {
  return render_1.typeRenderTestCase(__dirname, 'inputObjectType', inputObjectType_1.inputObjectType, [
    'InputF',
    'Input',
    'InputD',
    'InputMD',
