...
exports.getSubscriptionCreator = void 0
...
exports.getSubscriptionCreator = function(_a) {
  var uri = _a.uri,
    options = _a.options
  var client = new subscriptions_transport_ws_1.SubscriptionClient(
    uri,
    __assign({ lazy: true, reconnect: true }, options),
    WebSocket,
  )
  ...
  return function(gql) {
    return clientObservable.pipe(
      operators_1.concatMap(function(client) {
